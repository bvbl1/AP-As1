...
type OrderServiceClient interface {
	...
	UpdateOrderStatus(ctx context.Context, in *OrderStatusUpdateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	ListOrders(ctx context.Context, in *OrderFilterRequest, opts ...grpc.CallOption) (*OrderListResponse, error)
}
...
func (c *orderServiceClient) UpdateOrderStatus(ctx context.Context, in *OrderStatusUpdateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *OrderFilterRequest, opts ...grpc.CallOption) (*OrderListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	UpdateOrderStatus(context.Context, *OrderStatusUpdateRequest) (*emptypb.Empty, error)
	ListOrders(context.Context, *OrderFilterRequest) (*OrderListResponse, error)
...
func (UnimplementedOrderServiceServer) UpdateOrderStatus(context.Context, *OrderStatusUpdateRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateOrderStatus not implemented")
}
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *OrderFilterRequest) (*OrderListResponse, error) {
...
func _OrderService_ListOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ListOrders(ctx, req.(*OrderFilterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
