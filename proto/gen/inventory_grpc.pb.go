...
type InventoryServiceClient interface {
	...
	DeleteProduct(ctx context.Context, in *ProductIDRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *inventoryServiceClient) GetProduct(ctx context.Context, in *ProductIDRequest, opts ...grpc.CallOption) (*ProductResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductResponse)
...
func (c *inventoryServiceClient) DeleteProduct(ctx context.Context, in *ProductIDRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *inventoryServiceClient) CheckStock(ctx context.Context, in *StockCheckRequest, opts ...grpc.CallOption) (*StockCheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type InventoryServiceServer interface {
	...
	DeleteProduct(context.Context, *ProductIDRequest) (*emptypb.Empty, error)
...
func (UnimplementedInventoryServiceServer) GetProduct(context.Context, *ProductIDRequest) (*ProductResponse, error) {
...
func (UnimplementedInventoryServiceServer) DeleteProduct(context.Context, *ProductIDRequest) (*emptypb.Empty, error) {
...
func (UnimplementedInventoryServiceServer) CheckStock(context.Context, *StockCheckRequest) (*StockCheckResponse, error) {
...
func _InventoryService_GetProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).GetProduct(ctx, req.(*ProductIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _InventoryService_DeleteProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).DeleteProduct(ctx, req.(*ProductIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _InventoryService_CheckStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).CheckStock(ctx, req.(*StockCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
