...
func (c *userServiceClient) GetUserProfile(ctx context.Context, in *UserIDRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
func (UnimplementedUserServiceServer) GetUserProfile(context.Context, *UserIDRequest) (*UserResponse, error) {
